...
public final class Responses {
    ...
    public static ResponseContext error(Response.Status status, String code, String message) {
        return error(status, code, message, Collections.<ErrorDetail>emptyList());
    }
